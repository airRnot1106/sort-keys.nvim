...
describe("sort-keys.handlers.declarative.lua_builder", function()
  local builder
  local has_lua

  before_each(function()
    package.loaded["sort-keys.handlers.declarative.lua_builder"] = nil
    builder = require("sort-keys.handlers.declarative.lua_builder")
