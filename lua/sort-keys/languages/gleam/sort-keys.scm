...
;; definition `data_constructor_arguments`, record update
;; `record_update_arguments`, and a `case`-clause record pattern's
;; `record_pattern_arguments`. A positional argument (no label) keeps its slot,
